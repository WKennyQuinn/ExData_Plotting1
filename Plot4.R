...
#Creates and saves a plot as a Plot4.png in the working directory
...
plot(EnergyData$DateTime,EnergyData$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()